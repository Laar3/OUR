...
fetch() {
	...
	cp -n ../default.llvm.conf /etc/opk/llvm.conf
	[ ../default/llvm.conf -nt /etc/opk/llvm.conf ] && echo "WARNING: the default config file is newer than your config file." done
}
