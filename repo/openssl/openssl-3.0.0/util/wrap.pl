...
BEGIN {
    ...
    require '/home/spagett/OUR/repo/openssl/openssl-3.0.0/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/spagett/OUR/repo/openssl/openssl-3.0.0/test/fips-and-base.cnf';
    shift;
